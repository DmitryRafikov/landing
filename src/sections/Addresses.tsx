...
const Addresses = () => {
    ...
    return(
        <section className={"addresses"}>
            <div className="addresses__layout">
                <h1 className='addresses__header'>Где мы находимся?</h1>
                ...
                <button className={"button__black"} onClick={()=>dispatch(open())}>Забронировать</button>
            </div>
